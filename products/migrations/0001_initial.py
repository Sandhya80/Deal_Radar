    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'products',
                'indexes': [models.Index(fields=['site_name'], name='products_site_na_e793ec_idx'), models.Index(fields=['category'], name='products_categor_fce6e6_idx'), models.Index(fields=['is_active'], name='products_is_acti_cb485f_idx')],
            },
        ),
        migrations.CreateModel(
            name='TrackedProduct',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-timestamp'],
                'indexes': [models.Index(fields=['product', 'timestamp'], name='price_histo_product_bddde2_idx'), models.Index(fields=['timestamp'], name='price_histo_timesta_8cf394_idx')],
            },
        ),
        migrations.AddIndex(
